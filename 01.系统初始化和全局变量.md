...
+ kube-node1：192.168.1.110
+ kube-node2：192.168.1.111
+ kube-node3：192.168.1.112
...
192.168.1.110 kube-node1	kube-node1
192.168.1.111 kube-node2	kube-node2
192.168.1.112 kube-node3	kube-node3
```
...
``` bash
$ sudo useradd -m k8s
$ sudo sh -c 'echo admin | passwd k8s --stdin' # 为 k8s 账户设置密码
$ sudo visudo
...
# 集群各机器 IP 数组
export NODE_IPS=(192.168.1.110 192.168.1.111 192.168.1.112)
...
# etcd 集群服务地址列表
export ETCD_ENDPOINTS="https://192.168.1.110:2379,https://1192.168.1.111:2379,https://192.168.1.112:2379"

# etcd 集群间通信的 IP 和端口
export ETCD_NODES="kube-node1=https://192.168.1.110:2380,kube-node2=https://192.168.1.111:2380,kube-node3=https://192.168.1.112:2380"
